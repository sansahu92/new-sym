...
// Returns the private 'App\Repository\ConfiguratorItemsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ConfiguratorItemsRepository.php';

return $this->privates['App\Repository\ConfiguratorItemsRepository'] = new \App\Repository\ConfiguratorItemsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
