...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ConfiguratorItemsRepository' => function () {
    return ($this->privates['App\Repository\ConfiguratorItemsRepository'] ?? $this->load('getConfiguratorItemsRepositoryService.php'));
}, 'App\\Repository\\ConfiguratorOtherItemsOptionsRepository' => function () {
    return ($this->privates['App\Repository\ConfiguratorOtherItemsOptionsRepository'] ?? $this->load('getConfiguratorOtherItemsOptionsRepositoryService.php'));
}))));
