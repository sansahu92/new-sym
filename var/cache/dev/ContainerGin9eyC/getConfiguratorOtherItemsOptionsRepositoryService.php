...
// Returns the private 'App\Repository\ConfiguratorOtherItemsOptionsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ConfiguratorOtherItemsOptionsRepository.php';

return $this->privates['App\Repository\ConfiguratorOtherItemsOptionsRepository'] = new \App\Repository\ConfiguratorOtherItemsOptionsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
